...
def add_args(parser):
    ...
    parser.add_argument("--model_type", default="t5", type=str, choices=['roberta', 'bart', 't5'])

    parser.add_argument("--data_num", default=-1, type=int)
    parser.add_argument("--start_epoch", default=0, type=int)
    parser.add_argument("--num_train_epochs", default=50, type=int)
    parser.add_argument("--patience", default=6, type=int)
    parser.add_argument("--cache_path", default='./output/cache_path',type=str)
    parser.add_argument("--summary_dir", default='./output/summary_dir', type=str)
    parser.add_argument("--data_dir", default='data',type=str,)
    parser.add_argument("--res_dir", default='./output/res_dir', type=str)
    parser.add_argument("--res_fn", default='./output/res_fn', type=str)
    ...
    ## model paprameters t5-large  t5-small t5-base 
    parser.add_argument("--model_name_or_path", default="t5-base", type=str,
                        help="Path to pre-trained model: e.g. roberta-base")
    parser.add_argument("--config_name", default="t5-base", type=str,
    ...
    ## Required parameters 
    parser.add_argument("--output_dir", default='./output/output_dir', type=str,
    ...
    parser.add_argument("--max_source_length", default=56, type=int,
    ...
    parser.add_argument("--imporve", type=int, default=1,help="Whether to run eval on the train set.")
