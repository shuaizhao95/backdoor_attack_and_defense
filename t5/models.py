...
from transformers import (RobertaConfig, RobertaModel, RobertaTokenizer,
                          ...
                          T5Config, T5ForConditionalGeneration, T5Tokenizer, AutoConfig, AutoTokenizer, AutoModelForCausalLM)
import logging
...
MODEL_CLASSES = {'roberta': (RobertaConfig, RobertaModel, RobertaTokenizer),
                ...
                'gpt': (AutoConfig, AutoTokenizer, AutoModelForCausalLM)}
...
class Seq2Seq(nn.Module):
    ...
    def __init__(self, encoder, decoder, config, beam_size=None, max_length=None, sos_id=None, eos_id=None):
        ...
        self.s4_layers.append(S4(d_model=config.hidden_size, l_max=1024, bidirectional=True, postact='glu', dropout=0.2, transposed=True))
